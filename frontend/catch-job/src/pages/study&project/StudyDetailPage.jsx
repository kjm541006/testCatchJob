...
const StudyDetailPage = () => {
  ...
  const cancelApply = async (pMemId) => {
    try {
      const response = await axios.delete(
        `https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/cancel/${pMemId}`
      );
  ...
  const fetchComments = async () => {
    try {
      const response = await axios.get(`https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/${id}`, {
        headers,
      });
  ...
  const submitComment = async () => {
    ...
    try {
      const response = await axios.post(
        `https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/comment/${id}`,
        commentData
      );
      if (response.status === 200) {
        console.log("등록완료");
  ...
  const handleLikeBtn = async () => {
    try {
      const response = await axios.post(`https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/like/${id}`);
      // if (response.data.isLike === true) {
  ...
  const deleteProject = async () => {
    try {
      if (window.confirm("정말로 삭제하시겠습니까?")) {
        const response = await axios.delete(
          `https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/delete/${id}`,
          id
        );
        if (response.status === 200) {
          console.log("삭제완료");
  ...
  const finishProject = async () => {
    try {
      const response = await axios.put(`https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/done/${id}`);
      if (response.status === 200) {
  ...
  const deleteComment = async (commentId) => {
    try {
      const response = await axios.delete(
        `https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/comment/delete/${commentId}`
      );
      if (response.status === 200) {
  ...
  const updateProject = async () => {
    // try {
    //   const response = await axios.put(`https://classy-kleicha-484f07.netlify.app/.netlify/functions/proxy/studyDetail/edit/${id}`);
